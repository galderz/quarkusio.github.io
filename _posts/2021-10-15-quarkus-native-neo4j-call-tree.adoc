...
You can download the cypher script from link:../assets/examples/posts/quarkus-native-neo4j-call-tree/import.cypher[this link] or copy paste it in a file called `import.cypher`.
